...
export EVR_DRIVERS_PATH=/afs/slac/g/lcls/package/linuxKernel_Modules/evrmaDriver/master/buildroot-2014.08-glibc-x86_64
export EVRMA_PATH=/afs/slac/g/lcls/package/evrma/master/buildroot-2014.08-glibc-x86_64
export EVR_MANAGER_PATH=/afs/slac/g/lcls/package/evrManager/master/buildroot-2014.08-glibc-x86_64
